package com.example.springdemo.Controller.saToken;
...
public class LoginAuthController {
    ...
    // 会话登录接口  ---- http://localhost:8081/user/doLogin?name=zhang&pwd=123456
    ...
    // 查询当前登录状态  ---- http://localhost:8081/user/isLogin
    ...
    // 校验当前登录状态  ---- http://localhost:8081/user/checkLogin
    ...
    // 获取当前登录的账号是谁  ---- http://localhost:8081/user/getLoginId
    ...
    // 会话注销  ---- http://localhost:8081/user/logout
